...
class Index extends Component
{
    ...
    #[Locked]
    public $id;
    public $field = ['id', 'name', 'description', 'created_at', 'updated_at', 'deleted_at'];
    ...
    #[On('dispatch-item-create')]
    #[On('dispatch-item-update')]
    public function render()
    {
        $lists = $this->getLists();
        $permission = $this->permission;
        return view('livewire.item.index', compact('lists', 'permission'));
    }
    ...
    {
        $permission = $this->checkPermission($this->livePermission, 'item_status');
        if ($permission) {
