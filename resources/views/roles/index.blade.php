<x-app-layout>
    ...
    <div>
        <div class="mx-auto max-w-7xl sm:px-6 lg:px-2">
            <livewire:role.index :permission="$permission" :live_permission="$livePermission" :breadcrumbs="$breadcrumbs" :title="$title" :is_search="true"/>
        </div>
    </div>
</x-app-layout>
